...
from blue_hardware_drivers.msg import MotorState, GravityVectArr
import numpy as np
...
def main():
    ...
    motor_grav_pub = rospy.Publisher("blue_hardware/gravity_vectors", GravityVectArr, queue_size=1)
    accelCalibrator = AccelCalibrate(motor_names, motor_grav_pub)
    rospy.Subscriber("blue_hardware/motor_states", MotorState, accelCalibrator.get_accel, queue_size=1)
    #grav_pub0 = rospy.Publisher("blue_hardware/gravity0", Vector3, queue_size=1)
    #grav_pub1 = rospy.Publisher("blue_hardware/gravity1", Vector3, queue_size=1)
