...
class GripperClient(object):
    def __init__(self):
        side = sys.argv[1]
        ns = '/' + side + '_arm/koko_controllers/' + 'gripper_controller/'
...
def main():
    ...
    command_publisher = rospy.Publisher('/' + side + '_arm/koko_controllers/cartesian_pose_controller/command', PoseStamped, queue_size=1)
